...
rawdata <- read.csv("C:/Users/Dell-pc/Desktop/Github/Projects/Drug Regulatory Analysis/ac50_Matrix_190226.csv")
sdata <- read.csv("C:/Users/Dell-pc/Desktop/Github/Projects/Drug Regulatory Analysis/medNAS_dili_tt.csv", header = T)
